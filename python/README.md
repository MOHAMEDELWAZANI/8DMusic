...
<h1 align="center">8D Music — Python build</h1>
...
| **Reset to defaults** | Puts every effect control back to its factory value. Your output device and latency are left alone. |
...
· Deep Space · Figure Eight · Slowed & Sad · Old Radio
...
| `Ctrl+Shift+R` | Reset every effect setting to its default |
