...
function AndroidDevice({
  ...
  return (
    ...
    <div data-om-starter="android-frame" style={{
      ...
      <div style={{ flex: 1, overflowY: 'scroll', overflowX: 'hidden', scrollbarWidth: 'none' }} ref={el => { if (el && !el.dataset.sbHidden) { el.dataset.sbHidden = '1'; const s = document.createElement('style'); s.textContent = '[data-om-starter="android-frame"] *::-webkit-scrollbar{display:none;width:0;height:0}'; document.head.appendChild(s); } }}>
        {children}
      </div>
